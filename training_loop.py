...
from environments.env_test2 import TestProblem2
...
eval_problem_no = 'eval-problem-no'
...
for i in range(1,2):
    ...
    eval_callback = EvalCallback(eval_env = eval_env_rl, eval_env_lq = eval_env_lq, eval_freq=250, n_eval_episodes = 1, 
                                 deterministic=True, render=False, verbose = 1, eval_problem_no = eval_problem_no, log_path = './', name_prefix='rewards_run{}'.format(i))                              
