...
class EvalCallback(EventCallback):
    ...
    def __init__(
        ...
        eval_env_lq: Union[gym.Env, VecEnv],
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            if self.verbose > 0:
                # Problem 1, 2
                if self.eval_problem_no == 1 or self.eval_problem_no == 2:
                    print(f"Training steps={self.num_timesteps}, " f"MAFD={rel_dev}")
                # Problem 3
                if self.eval_problem_no == 3:
                    print(f"Eval num_timesteps={self.num_timesteps}, " f"rl_reward={rl_reward}, " f"rel_diff={rewards_ratio}")
