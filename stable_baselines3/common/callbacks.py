...
class EvalCallback(EventCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            # Problem 1
            eval_problem1 = EvalProb1()
            rel_dev, rel_dev10 = eval_problem1.evaluate(self.model, self.eval_env)
            # Problem 2
            #eval_problem2 = EvalProb2()
            #rel_dev = eval_problem2.evaluate(self.model)
            # Problem 3
            #eval_problem3 = EvalProb3()
            #rl_reward, lq_reward, rewards_ratio = eval_problem3.evaluate(self.model, self.eval_env, self.eval_env_lq)
